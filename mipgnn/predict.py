...
def get_prediction(model_name, graph, bias_threshold=0.00):
    ...
    if model_name_only[0:3] == "ECS" or model_name_only[0:8] == "Rand_ECS" or "trained" in model_name:
        ...
        from mipgnn.gnn_models.GIN.mip_bipartite_simple_class import SimpleNet
    elif model_name_only[0:4] == "GIN_":
        from mipgnn.gnn_models.GIN.mip_bipartite_class import SimpleNet
    elif model_name_only[0:3] == "SGS":
        from mipgnn.gnn_models.Sage.mip_bipartite_simple_class import SimpleNet
    elif model_name_only[0:3] == "SG_":
        from mipgnn.gnn_models.Sage.mip_bipartite_class import SimpleNet
    else:
    ...
    for i, (node, node_data) in enumerate(graph.nodes(data=True)):
        ...
        if node_data['bipartite'] == 0:
            ...
            if 'objcoeff' in node_data:
                ...
                obj.append([node_data["features"][0]])
